      ...
      <div class="card" id="tooltip-container">
        <div class="card-body">
          <i
            ...
            title="More Info"
          ></i>
          <h4 class="mt-0 font-16">Referral Income</h4>
          <h2 class="text-primary my-3 text-center">
            ৳<span data-plugin="counterup"> {{ @numberFormat($referral_income) }}</span>
          </h2>
    ...
    <div class="col-xl-6">
      <div class="card">
        <div class="card-body">
          ...
          <div class="mt-3 chartjs-chart">
            <canvas
              id="projections-actuals-chart"
              data-colors="#4a81d4,#e3eaef"
              height="300"
            ></canvas>
          </div>
        </div>
            ...
            >
              <div class="row">
                ...
                <div class="col-auto">
                  <button
                    type="submit"
                    class="btn btn-danger chat-send waves-effect waves-light w-100"
                  >
                    Send
                  </button>
                </div>

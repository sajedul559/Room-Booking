                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="review-form">
                                    ...
                                    <input type="text" class="form-control" placeholder="Enter Offer Price">
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row" id="floor-plan">
                ...
                <div class="col-lg-8">
                    <div class="add-property-wrap">
                        <div class="add-info">
                            <div class="row add-cont">
                                ...
                                <div class="col-md-4">
                                    <div class="review-form">
                                        <label class="d-none d-md-block">&nbsp;</label>
                                        <button class="btn btn-primary btn-upload"><i
                                                class="bx bx-cloud-upload"></i>Upload Photos</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
                                <div class="review-form text-end">
                                    <a href="javascript:void(0);" class="add-more"><i class="bx bx-plus"></i> Add
                                        More</a>
                                </div>
                            </div>
                        </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="property-submit">
                        ...
                        <a href="{{ url('buy-property-grid') }}" class="btn btn-primary">Add Property</a>
                    </div>
                </div>
            </div>

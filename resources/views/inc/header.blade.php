                ...
                <form class="app-search">
                    <div class="app-search-box dropdown">
                        ...
                        <div class="input-group">
                            ...
                            <body data-layout-mode="default" data-theme="light" data-topbar-color="dark"
                                data-menu-position="fixed" data-leftbar-color="light" data-leftbar-size='default'
                ...
                <div class="dropdown-menu dropdown-menu-end dropdown-lg">
                    ...
                    <div class="noti-scroll" data-simplebar>
                        ...
                        <a href="javascript:void(0);" class="dropdown-item notify-item active">
                            ...
                            <p class="notify-details"> Mahady </p>
                        ...
                        <a href="javascript:void(0);" class="dropdown-item notify-item">
                            ...
                            <p class="notify-details"> Najmus </p>
                            <p class="text-muted mb-0 user-msg">

                ...
                <div class="container-fluid">
                        ...
                        <li class="dropdown notification-list topbar-dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-end profile-dropdown ">
                                ...
                                <div class="dropdown-divider"></div>
                                 ...
                                 <a href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();" class="dropdown-item"><i class="fe-log-out"></i> Logout
                    ...
                    <div class="logo-box">
                        <a href="index.html" class="logo logo-dark text-center">
                            ...
                            <span class="logo-lg">
                                <img src="{{asset('assets/images/logo-sm.pngassets/images/logo-dark.png')}}" alt="" height="20">
                ...
                <div class="h-100" data-simplebar>
                    ...
                    <div id="sidebar-menu">
                        ...
                        <ul id="side-menu">
                            ...
                            <li>
                                ...
                                <div class="collapse" id="sidebarEcommerce">
                                    <ul class="nav-second-level">
                                        <li><a href="{{route('user.registration')}}">User Creation</a></li>
                            ...
                            <li>
                                ...
                                <div class="collapse" id="sidebarCrm">
                                    <ul class="nav-second-level">
                                        ...
                                        <li><a href="{{route('users.editPermissions')}}">User Permission</a></li>
                                    </ul>
                                </div>
                            </li>

                            <li class="menu-title mt-2">Application</li>

                            <li>
                                <a href="#sidebarBilling" data-bs-toggle="collapse">
                                    <i class="mdi mdi-account-multiple-outline"></i>
                                    <span>Billing </span>
                                    <span class="menu-arrow"></span>
                                </a>
                            ...
                            <li>
                                <a href="#sidebarAppointment" data-bs-toggle="collapse">
                                    <i class="mdi mdi-account-multiple-outline"></i>
                            ...
                            <li>
                                <a href="#sidebarIpd" data-bs-toggle="collapse">
                                    <i class="mdi mdi-account-multiple-outline"></i>
                                    <span>IPD </span>
                                    <span class="menu-arrow"></span>
                                </a>

                                <div class="collapse" id="sidebarIpd">
                                    <ul class="nav-second-level">
                                        <li><a href="{{route('ipd.search')}}">IPD</a></li>

                                    </ul>
                                </div>
                            </li>

                            <li class="menu-title mt-2">Setup</li>
                            <li>
                                ...
                                <div class="collapse" id="sidebarSetup">
                                    <ul class="nav-second-level">
                                        ...
                                        <li><a href="{{route('beds.index')}}">Bed</a></li>
                                        <li><a href="{{route('symptoms.index')}}">Symptom</a></li>
                                    </ul>
                                </div>
                            </li>

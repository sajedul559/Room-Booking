                ...
                <div class="card">
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="text-center">
                            ...
                            <p class="text-muted mb-0">It seems like you don't have the necessary permissions to view this page. Don't worry, it happens! You can try logging in again or contact the administrator for assistance.</p>
                        </div>
                        ...
                        <div class="row mt-3">
                            <div class="col-12 d-flex justify-content-center">
                                ...
                                <p class="mb-0 ms-3">
                                    <a href="{{ route('dashboard') }}" class="btn btn-success"><b>Return to Home</b></a>
                                </p>
                            </div> <!-- end col -->
                        </div>

        ...
        <div class="details-wrap">
            <div class="detail-user-wrap">
                <div class="detail-user-img">
                    <img src="{{URL::asset('frontend/img/agents/agent-01.jpg')}}" class="img-fluid" alt="Image">
                </div>
                <div class="user-wrap">
                    <div class="user-info-wrap">
                        <div class="detail-user-info">
                            ...
                            <p><i class="bx bx-user-voice"></i>Seller Agent at <span>Lux Realestate</span></p>
                        </div>
                        <div class="detail-action">
                            <a href="javascript:void(0);" class="btn btn-primary"><i class="bx bx-phone"></i>Call Me</a>
                            <a href="javascript:void(0);" class="btn btn-secondary"><i class="bx bxl-whatsapp"></i>WhatsApp</a>
                        </div>
                    </div>								
                    <ul class="mem-list">
            ...
            <div class="col-lg-8">
                ...
                <div class="agent-views">
                    ...
                    <div class="collapse-card">
                        <h4 class="card-title">
                            <a class="collapsed" data-bs-toggle="collapse" href="#about" aria-expanded="false">About Richard R. Roy</a>
                        </h4>
                    ...
                    <div class="collapse-card">
                        <h4 class="card-title">
                            <a class="collapsed" data-bs-toggle="collapse" href="#service-area" aria-expanded="false">Service Areas</a>
                        </h4>
                    ...
                    <div class="collapse-card spl-card">
                        <h4 class="card-title">
                            <a class="collapsed" data-bs-toggle="collapse" href="#specialities" aria-expanded="false">Specialities</a>
                        </h4>
                    ...
                    <div class="list-card">
                        <ul class="my-list nav">
                            <li>
                                <a href="javascript:void(0);" class="active" data-bs-toggle="tab" data-bs-target="#property">All Properties ( 25 )</a>
                            </li>
                            <li>
                                <a href="javascript:void(0);" data-bs-toggle="tab" data-bs-target="#apartment">Apartments ( 15 )</a>
                            </li>
                            <li>
                                <a href="javascript:void(0);" data-bs-toggle="tab" data-bs-target="#condos">Condos ( 5 )</a>
                            </li>
                            <li>
                                ...
                                <div class="agentview-slider owl-carousel feature-property-sec for-rent">
                                        ...
                                        <div class="profile-widget">
                                            <div class="pro-img">
                                                <a href="{{url('rent-details')}}" class="property-img">
                                                    <img class="img-fluid" alt="Property Image" src="{{URL::asset('frontend/img/product/product-7.jpg')}}">
                                                </a>
                                            ...
                                            <div class="pro-content">
                                                ...
                                                <ul class="d-flex details">
                                                    ...
                                                    <li>
                                                        <img src="{{URL::asset('frontend/img/icons/building-icon.svg')}}" alt="building-icon">
                                                        1200 Sqft
                                                    </li>
                                                </ul>
                                                <ul class="property-category d-flex justify-content-between align-items-center">
                                                    <li class="user-info">
                                                        <a href="javascript:void(0);"><img src="{{URL::asset('frontend/img/profiles/avatar-02.jpg')}}" class="img-fluid avatar" alt="User"></a>
                                                        <div class="user-name">
                                    ...
                                    <div class="product-custom">
                                        <div class="profile-widget">
                                            <div class="pro-img">
                                                <a href="{{url('rent-details')}}" class="property-img">
                                                    <img class="img-fluid" alt="Property Image" src="{{URL::asset('frontend/img/product/product-8.jpg')}}">
                                                </a>
                                                <div class="product-amount">
                                            ...
                                            <div class="pro-content">
                                                ...
                                                <ul class="property-category d-flex justify-content-between align-items-center">
                                                    <li class="user-info">
                                                        <a href="javascript:void(0);"><img src="{{URL::asset('frontend/img/profiles/avatar-03.jpg')}}" class="img-fluid avatar" alt="User"></a>
                                                        <div class="user-name">
                                    ...
                                    <div class="product-custom">
                                        <div class="profile-widget">
                                            <div class="pro-img">
                                                <a href="{{url('rent-details')}}" class="property-img">
                                                    <img class="img-fluid" alt="Property Image" src="{{URL::asset('frontend/img/product/product-9.jpg')}}">
                                                </a>
                                                <div class="product-amount">
                                            ...
                                            <div class="pro-content">
                                                ...
                                                <ul class="property-category d-flex justify-content-between align-items-center">
                                                    <li class="user-info">
                                                        <a href="javascript:void(0);"><img src="{{URL::asset('frontend/img/profiles/avatar-04.jpg')}}" class="img-fluid avatar" alt="User"></a>
                                                        <div class="user-name">
                        ...
                        <div id="review" class="card-collapse collapse show  collapse-view">
                            <div class="review-card">
                                <div class="customer-review">
                                    <div class="customer-info">
                                        <div class="customer-name">
                                            <a href="javascript:void(0);"><img src="{{URL::asset('frontend/img/profiles/avatar-01.jpg')}}" alt="User"></a>
                                            <div>
                                ...
                                <div class="customer-review">
                                    <div class="customer-info">
                                        <div class="customer-name">
                                            <a href="javascript:void(0);"><img src="{{URL::asset('frontend/img/profiles/avatar-02.jpg')}}" alt="User"></a>
                                            <div>
                    ...
                    <div class="sidebar-card">
                        ...
                        <div class="social-links">
                            <ul class="sidebar-social-links">
                                <li><a href="javascript:void(0);" class="fb-icon"><i class="fa-brands fa-facebook-f"></i></a></li>
                                <li><a href="javascript:void(0);" class="ins-icon"><i class="fa-brands fa-instagram"></i></a></li>
                                <li><a href="javascript:void(0);"><i class="fa-brands fa-behance"></i></a></li>
                                <li><a href="javascript:void(0);" class="twitter-icon"><i class="fa-brands fa-twitter"></i></a></li>
                                <li><a href="javascript:void(0);" class="ins-icon"><i class="fa-brands fa-pinterest-p"></i></a></li>

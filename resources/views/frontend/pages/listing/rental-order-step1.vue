            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <div class="booking-details-btn">
                        <router-link to="/rental-order-step1" class="btn btn-lightred me-2">Back to Booking Details</router-link>
                        <router-link to="/rental-order-step2" class="btn btn-primary">Go to Order Confirmation</router-link>
                    </div>
                </div>
            </div>
        </div>

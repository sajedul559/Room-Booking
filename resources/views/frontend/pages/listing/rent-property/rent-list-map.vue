            ...
            <div class="row">
                ...
                <div class="col-xl-5 col-sm-12 map-right ">
                    <div id="map" class="map-listing">
                        <GoogleMap api-key="YOUR_ACTUAL_API_KEY" @click="showInfo(marker)" style="width: 100%; height: 500px" :center="center"
                            :zoom="15">
                ...
                <div class="col-xl-7 col-sm-12 map-content">
                                        ...
                                        <div class="col-md-12 d-flex justify-content-md-end flex-wrap">
                                            <div class="sort-by grid-head">
                                                ...
                                                <div class="review-form">
                                                    <vue-select :options="Sort" id="mapsortlist"
                                                        placeholder="Default" />
                                                </div>
                                            </div>
                    ...
                    <div class="feature-property-sec for-rent rent-grid p-0 bg-white rental-map">
                        <div class="row ">
                            ...
                            <!-- Rent List -->
                            <div class="col-lg-12" v-for="record in RentListMap" :key="record.id">
                                        ...
                                        <div class="doc-img">
                                            <router-link to="/rent/rent-details" class="property-img">
                                                <img class="img-fluid" alt="Product image"
                                                    :src="require(`@/assets/img/rent/${record.Image}`)">
                                            </router-link>
...
import RentListMap from '@/assets/json/rent-list-map.json'

        ...
        <div class="container">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                ...
                                <div class="review-form mb-0">
                                    <vue-select :options="Select" id="selecttime" placeholder="Select Time" />
                                </div>
                            </div>
                            <div class="col-lg-6">
                                ...
                                <div class="review-form mb-0">
                                    <vue-select :options="Select" id="selecttimetwo" placeholder="Select Time" />
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-lg-12">
                <div class="booking-details-btn">
                    ...
                    <router-link to="/rental-order-step1" class="btn btn-primary">Go to Details</router-link>
                </div>
            </div>
        </div>
    </section>
...
export default {
    data() {
        return {
            ...
            Select: ["Select Time", "10 AM - 12 PM", "12 PM - 2 PM", "02 PM - 04 PM"]
        }
    },
}
</script>
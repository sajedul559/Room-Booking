            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="success-div">
                        <span><i class="bx bx-check-circle me-1"></i>Modern apartment in the city centre is available
                            for rental</span>
                    </div>
                </div>
                <div class="col-lg-12">
                        ...
                        <ul class="information-details mb-0">
                            <li class="me-0">
                                ...
                                <p>This property is mostly wooded and sits high on a hilltop overlooking the Mohawk
                                    River Valley. Located right in the heart Upstate NYs Amish farm Country, this land
                                    is certified organic making it extremely rare! </p>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="col-lg-12">
                    <div class="booking-details-btn">
                        <router-link to="/rental-order-step1" class="btn btn-lightred me-2">Back to Order Details</router-link>
                        <router-link to="/rental-order-step3" class="btn btn-primary">Go to Payment</router-link>
                    </div>
                </div>
            </div>
        </div>

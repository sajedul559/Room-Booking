      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="terms-policy">
            <p class="aos" data-aos="fade-down">
            ...
            <ul data-aos="fade-down">
              <li>
                <span><i class="fa-solid fa-circle-check"></i></span>At vero eos
                et accusamus et iusto odio dignissimos ducimus qui blanditiis
                praesentium voluptatum deleniti atque corrupti quos dolores et
              </li>
              <li>
                <span><i class="fa-solid fa-circle-check"></i></span>Sed ut
                perspiciatis unde omnis iste natus error sit voluptatem
                accusantium doloremque laudantium,
              </li>
              <li>
                <span><i class="fa-solid fa-circle-check"></i></span>Nemo enim

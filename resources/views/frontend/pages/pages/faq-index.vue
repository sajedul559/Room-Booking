        ...
        <div class="faq-card bg-white aos" data-aos="fade-down">
          <h4 class="faq-title">
            <a
              ...
              href="#faqOne"
              aria-expanded="false"
              >1. What are the costs to buy a house?</a
            >
          </h4>
        ...
        <div class="faq-card bg-white aos" data-aos="fade-down">
          <h4 class="faq-title">
            <a
              ...
              href="#faqTwo"
              aria-expanded="false"
              >2. What are the steps to sell a house?</a
            >
          </h4>
        ...
        <div class="faq-card bg-white aos" data-aos="fade-down">
          <h4 class="faq-title">
            <a
              ...
              href="#faqThree"
              aria-expanded="false"
              >3. Do you have loan consultants?</a
            >
          </h4>
        ...
        <div class="faq-card bg-white aos" data-aos="fade-down">
          <h4 class="faq-title">
            <a
              ...
              href="#faqFour"
              aria-expanded="false"
              >4. When will the project be completed?</a
            >
          </h4>
        ...
        <div class="faq-card bg-white aos" data-aos="fade-down">
          <h4 class="faq-title">
            <a
              ...
              href="#faqFive"
              aria-expanded="false"
              >5. When will the project be completed?</a
            >
          </h4>
        ...
        <div class="faq-card bg-white aos" data-aos="fade-down">
          <h4 class="faq-title">
            <a
              ...
              href="#faqSix"
              aria-expanded="false"
              >6. Lorem ipsum dolor sit amet, elit?</a
            >
          </h4>
        ...
        <div class="faq-card bg-white aos" data-aos="fade-down">
          <h4 class="faq-title">
            <a
              ...
              href="#faqSeven"
              aria-expanded="false"
              >7. Lorem ipsum dolor sit amet, elit?</a
            >
          </h4>
        ...
        <div class="faq-card bg-white aos" data-aos="fade-down">
          <h4 class="faq-title">
            <a
              ...
              href="#faqEight"
              aria-expanded="false"
              >8. Lorem ipsum dolor sit amet, elit?</a
            >
          </h4>
        ...
        <div class="faq-card bg-white aos" data-aos="fade-down">
          <h4 class="faq-title">
            <a
              ...
              href="#faqNine"
              aria-expanded="false"
              >9. Lorem ipsum dolor sit amet, elit?</a
            >
          </h4>
        ...
        <div class="faq-card bg-white aos" data-aos="fade-down">
          <h4 class="faq-title">
            <a
              ...
              href="#faqTen"
              aria-expanded="false"
              >10. Lorem ipsum dolor sit amet, elit?</a
            >
          </h4>

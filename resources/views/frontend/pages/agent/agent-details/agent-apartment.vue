<template>
    ...
    <div class="agentpro-list">
      <div class="agentview-slider owl-carousel feature-property-sec for-rent">
        ...
        >
          <Slide v-for="record in Agency_Apartment" :key="record.id">
            <div class="product-custom">
              <div class="profile-widget">
                <div class="pro-img">
                  <router-link to="/rent/rent-details" class="property-img">
                    <img
                      ...
                      alt="Property Image"
                      :src="
                        require(`@/assets/img/product/${record.ProductImage}`)
                      "
                    />
                  </router-link>
                  <div class="product-amount">
                    <h5>
                      <span>{{ record.Amount }} </span> / Night
                    </h5>
                  </div>
                  <div class="featured">
                    <span>Featured</span>
                ...
                <div class="pro-content text-start">
                  <div class="rating">
                  ...
                  >
                    ...
                    <li>
                      <router-link to="/rent/rent-details" class="btn-primary"
...
import Agency_Apartment from "@/assets/json/agency-apartment.json";
export default {
  data() {
    return {
      isSelected: false,
      Agency_Apartment: Agency_Apartment,
      settings: {
        itemsToShow: 1,
        snapAlign: "center",
      },
